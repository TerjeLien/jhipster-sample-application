package com.lien.test.repository;

import com.lien.test.JhipsterSampleApplicationApp;
import com.lien.test.config.Constants;
import com.lien.test.config.audit.AuditEventConverter;
import com.lien.test.domain.PersistentAuditEvent;
...
import static com.lien.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
